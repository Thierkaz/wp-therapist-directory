    ...
    <div class="td-single">
        ...
        <div class="td-single-body">
            ...
            <aside class="td-single-sidebar">
                <div class="td-single-contact-card">
                    <h3><?php esc_html_e( 'Contact', 'therapist-directory' ); ?></h3>

                    <?php if ( $telephone_affiche ) : ?>
                        <a href="tel:<?php echo esc_attr( preg_replace( '/\s+/', '', $telephone_affiche ) ); ?>" class="td-single-contact-item td-single-contact-phone">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <?php if ( $tel_pro_2 ) : ?>
                        <a href="tel:<?php echo esc_attr( preg_replace( '/\s+/', '', $tel_pro_2 ) ); ?>" class="td-single-contact-item">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/>
                            </svg>
                    ...
                    <?php if ( $email ) : ?>
                        <a href="mailto:<?php echo esc_attr( $email ); ?>" class="td-single-contact-item">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <?php if ( $site_internet ) : ?>
                        <a href="<?php echo esc_url( $site_internet ); ?>" target="_blank" rel="noopener noreferrer" class="td-single-contact-item">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
